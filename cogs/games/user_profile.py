...
class GearSelectView(ui.View):
    def __init__(self, parent_view: ProfileView, gear_type: str):
        ...
        GEAR_SETTINGS = {
            ...
            "hoe":          (FARM_TOOL_CATEGORY, "괭이", "괭이 해제", BARE_HANDS),
            "watering_can": (FARM_TOOL_CATEGORY, "물뿌리개", "물뿌리개 해제", BARE_HANDS)
        }
    ...
    async def setup_and_update(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(
            ...
            description=gear_select_strings.get("embed_description", "장착할 아이템을 선택하세요."), 
