...
class GuideSender(commands.Cog):
    ...
    async def send_guide(self, interaction: discord.Interaction, channel: discord.TextChannel):
        ...
        embed1 = discord.Embed(
            title="🏡 𝗗𝗜𝘀𝗰𝗼𝗿𝗱 𝗩𝗶𝗹𝗹𝗮𝗴𝗲에 오신 것을 환영합니다! - 게임 봇 안내서 🌟",
            description=(
        ...
        embed2.add_field(
            ...
            value=(
                ...
                "**- 방법:** 레벨 달성 시 <#1412417822964846632>에 개인 스레드가 자동 생성되어 안내합니다."
            ),
            inline=False
        )
        ...
        embed3.add_field(name="**1. 낚시** <#1412052442178387988>, <#1412052437983957174>", value="낚싯대와 미끼를 장착하고, 타이밍에 맞춰 물고기를 낚아보세요! 월척이나 희귀 어종을 낚을 수도 있습니다.", inline=False)
        embed3.add_field(name="**2. 농사** <#1412052457344733314>", value="개인 농장에서 밭을 갈고, 씨앗을 심고, 물을 주어 작물을 수확하세요. 비 오는 날은 물주기가 자동입니다!", inline=False)
        embed3.add_field(name="**3. 채광** <#1413582266155929680>", value="`광산 입장권`을 사용해 개인 광산에 입장하고, `곡괭이`로 광석을 찾아 채굴하세요.", inline=False)
        embed3.add_field(name="**4. 요리** <#1412052480413536276>", value="`가마솥`에 다양한 재료를 조합하여 요리를 만드세요. 숨겨진 레시피를 최초로 발견하고 명성을 얻을 수 있습니다.", inline=False)
        embed3.add_field(name="**5. 대장간** <#1412052472985424053>", value="광물과 코인을 사용하여 각종 도구를 더 높은 등급으로 업그레이드할 수 있습니다. (24시간 소요)", inline=False)
        ...
        embed4.add_field(name="**1. 펫 얻기** <#1412052428785844227>", value="보유한 알을 부화기에 넣어 펫을 얻습니다.", inline=False)
        embed4.add_field(name="**2. 펫 관리 및 성장** (개인 스레드)", value="먹이주기, 놀아주기, 스탯 분배, 진화를 통해 펫을 성장시킬 수 있습니다.", inline=False)
        embed4.add_field(name="**3. 펫과 함께하는 모험**", value="**- 탐사 <#1421920552649494703>:** 펫을 탐사 보내 보상을 얻어오게 합니다.\n**- 대전 <#1422386181940838440>:** 다른 유저의 펫과 실력을 겨룹니다.", inline=False)
        embed4.add_field(name="**4. 보스 레이드** <#1422133210820907019>, <#1422133201832251413>", value="모든 주민이 힘을 합쳐 강력한 보스를 처치하고 피해량 순위에 따라 보상을 받습니다.", inline=False)
        ...
        embed5.add_field(name="**1. 미니게임 (카지노)**", value="<#1412416876209766521>, <#1412416908191596614>, <#1412416919046197269> 채널에서 운을 시험하고 코인을 획득하세요.", inline=False)
