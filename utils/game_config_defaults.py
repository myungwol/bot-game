...
# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
JOB_SYSTEM_CONFIG = {
    # 직업 키와 역할 키를 매핑합니다. (서버 관리 봇의 설정과 일치해야 합니다)
    "JOB_ROLE_MAP": {
    ...
    # 레벨에 따라 부여될 주민 등급 역할입니다. 높은 레벨부터 순서대로 기입해야 합니다.
    "LEVEL_TIER_ROLES": [
    ...
    50: [
        {
            ...
            "description": "물고기를 낚는 것에 특화된 전문가입니다.",
            "abilities": [
                {
                ...
                },
                {
                    ...
                    "ability_name": "날렵한 챔질",
                    "description": "물고기가 미끼를 무는 데 걸리는 시간이 전반적으로 단축됩니다."
                }
            ]
        },
        {
            ...
            "description": "작물을 키우고 수확하는 것에 특화된 전문가입니다.",
            "abilities": [
                {
                ...
                },
                {
                    ...
                    "ability_name": "수분 유지력 향상",
                    "description": "작물이 수분을 더 오래 머금어, 물을 주는 주기가 길어집니다."
                }
            ]
        }
    ],
    ...
    100: [
        {
            ...
            "description": "낚시의 경지에 이르러 전설의 물고기를 쫓는 자. '낚시꾼'의 상위 직업입니다.",
            "prerequisite_job": "fisherman", # '낚시꾼' 직업이 필요합니다.
            "abilities": [
                {
                    "ability_key": "fish_rare_up_2",
                    "ability_name": "희귀 어종 전문가",
                    "description": "희귀한 물고기를 낚을 확률이 대폭 상승합니다."
                },
                {
                    "ability_key": "fish_size_up_2",
                    "ability_name": "월척 전문가",
                    "description": "낚는 물고기의 평균 크기가 눈에 띄게 커집니다."
                }
            ]
        },
        {
            ...
            "description": "농업의 정수를 깨달아 대지로부터 풍요를 얻는 자. '농부'의 상위 직업입니다.",
            "prerequisite_job": "farmer", # '농부' 직업이 필요합니다.
            "abilities": [
                {
                    "ability_key": "farm_yield_up_2",
                    "ability_name": "풍년의 지혜",
                    "description": "작물 수확 시, 수확량이 대폭 증가합니다."
                },
                {
                    "ability_key": "farm_growth_speed_up_2",
                    "ability_name": "성장의 대가",
                    "description": "작물의 성장 시간이 큰 폭으로 단축됩니다."
                }
            ]
        }
    ]
