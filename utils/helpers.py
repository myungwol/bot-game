...
def format_embed_from_db(embed_data: Dict[str, Any], **kwargs: Any) -> discord.Embed:
    if not isinstance(embed_data, dict):
        ...
        return discord.Embed(title="エラー", description="埋め込みデータの読み込みに失敗しました。", color=discord.Color.red())
    ...
    try:
        ...
        return discord.Embed(title="エラー", description="埋め込み形式の作成に失敗しました。", color=discord.Color.red())
