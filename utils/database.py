# bot-game/utils/database.py (서버 전체 쿨타임 관리 기능 추가)
...
async def get_user_gear(user_id_str: str) -> dict:
    default_rod, default_bait = get_config("DEFAULT_ROD", "古い釣竿"), "エサなし"
